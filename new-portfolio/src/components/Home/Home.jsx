        ...
        <div className="h-screen w-screen lg:pt-[1.5rem]  grid grid-cols-1 lg:grid-cols-2 ">
            ...
            <div className="order-2 lg:order-1  pt-14 px-4 lg:ps-10 lg:py-[12rem] lg:space-y-2 relative animate-slideInFromLeft text-center lg:text-left">
                ...
                <div className="pt-4 flex flex-col lg:flex-row items-center lg:items-baseline">
                    <h3 className="text-[#575757] font-bold text-xl lg:text-3xl ">
                        I&apos;m a&nbsp;
                    </h3>
                        <span
                        className="font-bold text-xl lg:text-3xl text-[#000000] pb-2 pr-4 border-orange-500 break-words lg:whitespace-nowrap"
                    >
                        {currentTitle}
                    </span>
                </div>
                <p className="text-[#575757] text-base font-semibold lg:text-lg pt-2 lg:pr-16 leading-relaxed">
                ...
                {/* Contact Button */}
                <div className="flex items-center justify-center lg:items-start lg:justify-start pt-4 w-full">
                    <a
                        href="/WilliamCole_CV.pdf"
                        download="WilliamCole_CV.pdf"
                        className="bg-[#000000] text-white py-2 px-4 lg:py-4 lg:px-6 rounded-lg hover:bg-gray-700 transition duration-300 flex items-center gap-2"
                    >
                        <div className="pb-1">
                            <img
            ...
            {/* Image Section */}
            <div className="order-1 lg:order-2 bg-[#000000]  py-12 flex justify-center items-center animate-slideInFromRight shadow-none">
                <div
