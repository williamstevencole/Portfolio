    ...
    return (
        <div className="h-screen w-screen lg:pt-[1.5rem] bg-[#b9927e] grid grid-cols-1 lg:grid-cols-2 ">
            ...
            <div className="order-2 lg:order-1 pt-14 px-4 lg:ps-10 lg:py-[12rem] lg:space-y-2 relative animate-slideInFromLeft text-center lg:text-left">
                ...
                <p className="text-white text-base font-semibold lg:text-lg pt-2 lg:pr-16 leading-relaxed">
                ...
                <div className="flex items-center justify-center lg:items-start lg:justify-start pt-2 lg:pt-4 w-full">
                    <a
                        ...
                        className="bg-[#705344] text-white py-2 px-4 lg:py-4 lg:px-6 rounded-lg hover:bg-gray-600 transition duration-300 flex items-center gap-2"
                    >
                        <div className="pb-1">
                            <img
            ...
            {/* Image Section */}
            <div className="order-1 lg:order-2 bg-[#705344]  py-12 flex justify-center items-center animate-slideInFromRight shadow-none">
                <div
